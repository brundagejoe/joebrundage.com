    ...
    <div className="min-h-screen">
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-4xl px-6 py-10 flex flex-col gap-6">
          ...
          <ul className="space-y-2 list-disc list-inside text-muted-foreground">
            <li>
              Own and evolve cross-cutting systems that span frontend, backend,
              and infrastructure
            </li>
            <li>
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-4xl px-6 py-10 flex flex-col gap-6">
          ...
          <ul className="space-y-2 list-disc list-inside text-muted-foreground">
            <li>
              Design architectures and provide technical direction across teams
            </li>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                pages to SSR. This required careful coordination and incremental
                rollout. The migration resulted in meaningful performance and
                conversion improvements and established a more scalable
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Designed and implemented multivariate testing for aggressively
                cached pages without introducing content flash or performance
                regressions. Used CloudFront functions to balance
                experimentation needs with caching and latency constraints.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Designed ranking algorithms that make results context-aware of
                one another. This work involved reviewing academic research,
                evaluating tradeoffs, and delivering a performant,
            ...
            <div className="flex flex-col gap-2">
              <h3 className="text-xl font-semibold">Technical SEO Systems</h3>
              <p className="text-muted-foreground leading-relaxed">
                Currently leading technical SEO work as a large, data-driven
                system rather than a collection of optimizations. The work spans
                ranking strategy, infrastructure, data analysis, and long-term
                technical planning across multiple stakeholders.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-4xl px-6 py-10 flex flex-col gap-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            I have a computer science background with an emphasis in computer
            graphics, which informs how I approach performance, algorithms, and
            system design. While my day-to-day work is product-focused, I'm
            comfortable working close to the metal when performance or
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-4xl px-6 py-10 flex flex-col gap-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            , a peer-to-peer storage marketplace that connects people who need
            storage space with those who have unused space in their homes or
            properties. I've grown by taking on increasingly complex systems and
            higher-impact responsibilities in a fast-moving environment.
          </p>
        </div>
      </section>
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-4xl px-6 py-10 flex flex-col gap-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            quickly, and think deeply about tradeoffs, I'd love to connect. You
            can reach me at{" "}
