...
type ExampleKey = "medical" | "spam" | "security" | "librarian"
...
const EXAMPLES: ExampleConfig[] = [
  ...
  },
  {
    ...
    priorLabel: "Chance an incoming message is spam before looking at this word.",
    likelihoodLabel:
  ...
  },
  {
    ...
    title: "Fraud alert",
    description:
      "Fraud is uncommon, so alert precision depends heavily on false positives.",
    priorPercent: 2,
    truePositivePercent: 90,
    falsePositivePercent: 3,
    priorLabel: "Chance a transaction is fraudulent before this alert fires.",
    likelihoodLabel:
      "If a transaction is fraudulent, chance this alert triggers.",
    falsePositiveLabel:
      "If a transaction is legitimate, chance this alert still triggers.",
  },
  {
    key: "librarian",
...
export default function BayesPlaygroundPage() {
  const [activeExample, setActiveExample] = React.useState<ExampleKey>("medical")
  ...
  const falsePositivesPer10k =
    (1 - result.prior) * result.falsePositive * 10000
      ...
      <section className="mx-auto max-w-4xl px-6 py-8">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 rounded-md border border-border p-4 text-sm">
            ...
            <p className="mt-2">
              In this setup,{" "}
              <span className="font-medium">P(E)</span> = P(E|H) * P(H) + P(E|not
              H) * (1 - P(H)).
            </p>
            <p className="mt-2 text-muted-foreground">
