...
const projects: { name: string; description: string; logo: JSX.Element }[] = [
  {
    name: "Rec41",
    description:
  ...
  },
  {
    ...
    description:
      "BYU's Animated Capstone Project from the class of 2023. I was an FX TD in charge of the fire in the film. I also lead the early research and development in the pipeline for the film.",
    logo: <FilmIcon />,
  },
  {
