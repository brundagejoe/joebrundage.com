...
export default function SpencerChapter() {
  ...
  return (
    <>
      <div className="flex w-full flex-col items-center scroll-smooth font-[Garamond]">
        ...
        <div
          ref={contentRef}
          className="prose relative mt-10 max-w-3xl px-6 prose-p:text-xl/8 md:px-24"
        ...
        >
          <div
            ...
            className="group w-fit rounded-lg border-2 border-black p-1 hover:bg-black"
          >
